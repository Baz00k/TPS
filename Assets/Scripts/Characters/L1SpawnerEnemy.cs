...
public class L1SpawnerEnemy : MonoBehaviour
{
    [SerializeField]
    ...
    private Vector3 GetRandomNavMeshPoint()
    {
        ...
        Vector3 minPoint = new Vector3(-5f, -26f, 0f); // Określ minimalny punkt w obszarze NavMesh
        Vector3 maxPoint = new Vector3(5f, -26f, 0f); // Określ maksymalny punkt w obszarze NavMesh

        for (int i = 0; i < 30; i++) // Spróbuj 30 razy, aby znaleźć punkt na NavMesh
        {
